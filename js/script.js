...
confirm ('Este juego consiste en adivinar un número de 3 dígitos en menos de 10 intentos. Yo te diré qué dígitos has adivinado y cuáles son incorrectos. ¿Comenzamos?')
...
function generarNumeroAleatorio () {
    while (numeroCorrecto.length < 3){
        let numeroAleatorio = Math.floor(Math.random() * 10)
        if (!numeroCorrecto.includes(numeroAleatorio)){
            numeroCorrecto.push(numeroAleatorio)
        }
    }
    return numeroCorrecto
}
generarNumeroAleatorio()
console.log('El número aleatorio generado es: '+ numeroCorrecto.join(' '))
...
// //Creo un ciclo con un máximo de 15 intentos que pida al usuario ingresar 3 dígitos. Cotejo y devuelvo info llamando a las funciones. Repito ciclo hasta que los tres dígitos coincidan o hasta que se agoten los intentos.
...
//         numeroIngresado = [digito1, digito2, digito3]
//         console.log('El número ingresado es: '+numeroIngresado.join(' '))
//         alert('El número ingresado es: '+numeroIngresado.join(' '))
//         compararDigito1()
//         compararDigito2()
//         compararDigito3()
//         alert('\nEl primer dígito es '+compararDigito1()+'\nEl segundo dígito es '+compararDigito2()+'\nEl tercer dígito es '+compararDigito3())

//     }while (digito1 == numeroAleatorio1 && digito2 == numeroAleatorio2 && digito3 == numeroAleatorio3)
...
//     }
// }
// alert('Lo siento, se acabaron los intentos disponibles. \nSi lo deseas, puedes reiniciar la página y volver a jugar.')
